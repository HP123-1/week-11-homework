...
public class HW2 extends BaseTest {
    ...
    public void Register() {
        ...
        driver.findElement((By.xpath("//input[@id='FirstName']"))).sendKeys("oscar");
        driver.findElement((By.xpath("//input[@id='LastName']"))).sendKeys("lalu");
        ...
        driver.findElement((By.xpath("//input[@name='Email']"))).sendKeys("yop1@gmail.com");
